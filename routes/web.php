...
Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function() {
    ...
    Route::group(['prefix' => '/product_images'], function () {
        Route::get('/{product_image}', \App\Http\Controllers\ProductImage\ShowController::class)->name('product_image.show');
        Route::delete('/{product_image}', \App\Http\Controllers\ProductImage\DeleteController::class)->name('product_image.delete');
    });

    Route::group(['prefix' => '/reviews'], function () {
        Route::delete('/{review}', \App\Http\Controllers\Product\Review\DeleteController::class)->name('review.delete');
    });
    ...
    Route::get('/error', \App\Http\Controllers\Error\IndexController::class)->name('error.index');
});
...
Route::get('/home', \App\Http\Controllers\HomeController2::class)->name('home');

Route::get('/{page}', \App\Http\Controllers\Client\IndexController::class)->where('page', '.*')->name('client.main.index');
