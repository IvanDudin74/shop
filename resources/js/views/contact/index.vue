          ...
          <div class="row mt--30">
            ...
            <div class="col-xl-4 col-lg-6 wow fadeInUp animated">
              <div class="contact-page-info__single mt-30">
                ...
                <div class="contact-box">
                  ...
                  <ul>
                    <li>
                      <p>Телефон: <a href="tel:123456789">068 26589 996</a></p>
                    </li>
                    <li>
                      <p>Горячая линия: <a href="tel:123456789">26886</a></p>
                    </li>
                    <li>
            ...
            <div class="col-xl-4 col-lg-6 wow fadeInUp animated">
              <div class="contact-page-info__single mt-30 ">
                ...
                <div class="contact-box">
                  <h4> Режим работы</h4>
                  <p class="text1">Понидельник - Пятница: 08:30 - 20:00</p>
                  <p class="text2">Суббота и Воскресенье: 09:30 - 21:30</p>
                </div>
              </div>
            </div>
          </div>
